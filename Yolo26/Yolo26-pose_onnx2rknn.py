...
# 模型文件路径
MODEL_PATH = os.path.join(current_path, 'models_convert/onnx/yolo26s-pose_[1,3,320,640].onnx')

# 导出路径
RKNN_MODEL = os.path.join(current_path, 'models_convert/rknn/yolo26s-pose_i8[1,320,640,3].rknn')
